...
public class CS359DB {
    ...
    private static final String UNAME = "csd3387"; // Share your repo to give you the credentials
    private static final String PASSWD = "Q&3mAy52";  // Share your repo to give you the credentials
